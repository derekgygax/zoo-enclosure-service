package local.zoo.enclosure_service.security;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .formLogin(form -> form.defaultSuccessUrl("/").permitAll()) // Updated form login configuration
                .logout(LogoutConfigurer::permitAll); // Optional logout configuration
        return http.build();
    }
}


//package com.vva.blogservice.security;
//
